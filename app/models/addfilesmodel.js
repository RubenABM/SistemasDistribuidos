...
module.exports.saveContent = async function(con) {
    try {
        ...
        let sql =
            "INSERT " +
            "INTO content " +
            "(con_user_id, con_cat_id, con_stu_pro_id, con_name, con_url) " +
            "VALUES ($1, $2, $3, $4, $5) " +
            "RETURNING con_id";

        let result = await pool.query(sql, [con.con_user_id, con.con_cat_id, con.con_stu_pro_id, con.con_name, con.con_url]);
